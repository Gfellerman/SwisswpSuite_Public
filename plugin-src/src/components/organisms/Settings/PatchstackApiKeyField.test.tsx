/**
 * Vitest coverage for PatchstackApiKeyField (F6, 2026-08-18 — purchase-path
...
type PatchstackModule = typeof import("./PatchstackApiKeyField");
...
let PatchstackApiKeyField: PatchstackModule["PatchstackApiKeyField"];
...
beforeAll(async () => {
  ...
  ({ PatchstackApiKeyField } = await import("./PatchstackApiKeyField"));
  ({ render, screen, cleanup } = await import("@testing-library/react"));
  ({ PRO_UPGRADE_URL } = await import("../../../lib/edition"));
  void (await import("../../../hooks/useSettings")) as unknown as SettingsModule;
  React = await import("react");
});

describe("PatchstackApiKeyField — locked-plan upsell link", () => {
  afterEach(() => {
  ...
  it("points 'Learn more' at the live products page, not the dead /pricing URL", () => {
    render(
      React.createElement(PatchstackApiKeyField, {
        settings: {} as never,
